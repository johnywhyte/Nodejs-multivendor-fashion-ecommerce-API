...
// @route GET /api/v1/stores/store/radius/:zipcode/:distance
// @access Private
...
exports.storePhotoUpload = asyncHandler (async (req, res, next) => {
  ...
  //Create custome name property
  file.name = `photo${store._id}${path.parse(file.name).ext}`;
